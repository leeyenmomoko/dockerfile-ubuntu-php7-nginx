...
RUN ln -s /opt/openresty/nginx/sbin/nginx /opt/openresty/bin/nginx
...
RUN cp /opt/openresty/nginx/conf/nginx.conf /opt/openresty/nginx/conf/nginx.conf.original
